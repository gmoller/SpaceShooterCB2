        ...
        public static void Create(Vector2 position, Vector2 velocity, GameState state)
        {
            ...
            switch (type)
            {
                case EnemyType.Gunship:
                    ...
                    state.Tags[entityId] = state.Tags[entityId].SetBits((int)Tag.IsAlive, (int)Tag.EnemyIsShooter, (int)Tag.IsEnemy);
                ...
                case EnemyType.Chaser:
                    ...
                    state.Tags[entityId] = state.Tags[entityId].SetBits((int)Tag.IsAlive, (int)Tag.EnemyIsChaser, (int)Tag.IsEnemy);
                ...
                case EnemyType.Carrier:
                    ...
                    state.Tags[entityId] = state.Tags[entityId].SetBits((int)Tag.IsAlive, (int)Tag.IsEnemy);
